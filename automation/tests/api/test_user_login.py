...
def test_login_user(api_base_url, register_user):
...
def test_login_user_invalid_email(api_base_url, register_user):
    senha = register_user["senha"]
    login_data = {
...
def test_login_user_invalid_password(api_base_url, register_user):
    email = register_user["email"]
    login_data = {
        "email": email,
...
def test_login_user_empty_email(api_base_url, register_user):
    senha = register_user["senha"]
    login_data = {
        "email": "",
        "senha": senha
...
def test_login_user_empty_password(api_base_url, register_user):
    email = register_user["email"]
    login_data = {
        "email": email,
        "senha": ""
...
def test_login_user_empty_email_and_password(api_base_url):
    login_data = {
        "email": "",
        "senha": ""
    }
